...
<head>
  ...
  <link rel="stylesheet" href="<?php echo config('constants.ADMIN_THEME_URL'); ?>dist/css/skins/skin-blue.min.css">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <AdminUser Image -->
                        <img src="<?php echo config('constants.ADMIN_THEME_URL'); ?>dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                      </div>
          ...
          <AdminUser Account Menu -->
          <li class="dropdown user user-menu">
            <!-- Menu Toggle Button -->
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <!-- The user image in the navbar-->
              <img src="<?php echo config('constants.ADMIN_THEME_URL'); ?>dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo config('constants.ADMIN_URL'); ?>logout" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="#"><i class="fa fa-link"></i> <span>Another Link  {{ session('status') }}</span></a></li>
        <li class="treeview">
...
<!-- AdminLTE App -->
<script src="<?php echo config('constants.ADMIN_THEME_URL'); ?>dist/js/adminlte.min.js"></script>
